...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            var messages = await _context.Messages.Where(m => m.SenderId == recepientId && m.RecepientId == userId && m.RecepientDeleted == false ||
                                                        m.SenderId == userId && m.RecepientId == recepientId && m.SenderDeleted == false)
